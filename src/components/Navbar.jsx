  ...
  return (
    <div className="align-middle w-full bg-slate-100 top-0 left-0 h-24 flex flex-row border-b-[3px] justify-between lg:px-16 px-4  items-center border-[#495678]">
      ...
      <button
        type="button"
        onClick={Logout}
        className="inline-flex justify-center rounded-md border border-transparent py-2 px-4 text-sm font-medium text-slate-600 hover:text-[#c30101] transition-all w-fit h-fit"
      >
